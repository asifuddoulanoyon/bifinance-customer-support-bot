...
from database import create_case, add_message, get_user_open_case
import re
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.text:
        ...
        add_message(case_id, "user", update.message.first_name, "video", file_id)
    elif update.message.document:
        file_id = update.message.document.file_id
        add_message(case_id, "user", update.message.first_name, "document", file_id)
